...
class System:
    def __init__(self):
        ...
        self.mag_Ainv = np.array([[ 4.53302188, 0.38404034, 1.193893],
                                  [0.38404034,  5.28919261,  -0.02217648],
                                  [1.193893,  -0.02217648,  4.9784628]])
        self.mag_b = np.array([-0.31396468, 0.16218444, -0.33313335]).transpose()

        ########################################
        #self.mag_Ainv = np.array([[ 2.7636437, 0.13572254, -0.02318757],
         #                         [0.13572254,  2.87704649,  -0.01019064],
          #                        [-0.02318757,  -0.01019064,  2.90377839]])
        #self.mag_b = np.array([-0.19348, 0.18735865, -0.1293981]).transpose()
        #[[-0.19565423, 0.21861439,-0.26010648]]
